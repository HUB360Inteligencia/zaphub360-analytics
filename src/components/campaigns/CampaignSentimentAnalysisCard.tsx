...
interface CampaignSentimentAnalysisCardProps {
  sentimentAnalysis: {
...
const CampaignSentimentAnalysisCard = ({ sentimentAnalysis }: CampaignSentimentAnalysisCardProps) => {
  ...
  return (
    <Card className="glass-card glass-card-dark border-white/20 shadow-2xl">
      <CardHeader>
        ...
        <CardDescription className="text-foreground/70">Classificação emocional dos contatos que responderam</CardDescription>
      </CardHeader>
      <CardContent>
        {hasData ? (
          ...
          <div className="h-72 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-xs text-muted-foreground">Os sentimentos serão exibidos conforme os contatos responderem</p>
            </div>
          </div>
        )}
      </CardContent>
...
export default CampaignSentimentAnalysisCard;